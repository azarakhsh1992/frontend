...
export default function ColumnGroupingTable({MyCabinetData}) {
    ...
    return (
        <Paper sx={{ width: '100%' }}>
            <TableContainer sx={{ maxHeight: 440 }}>
                <Table stickyHeader aria-label="sticky table">
                    ...
                    <TableBody>
                        ...
                        {/*    })}*/}
                        {
                            Object.keys(MyCabinetData && MyCabinetData).slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((value, index)=>{

                                return (
                                    <TableRow hover role="checkbox" tabIndex={-1} key={value}>
                                        {
                                            MyCabinetArray.map((value1, index1)=>{
            ...
            <TablePagination
                ...
                component="div"
                count={Object.keys(MyCabinetData).length}
